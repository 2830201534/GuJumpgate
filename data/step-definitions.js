(function attachStepDefinitions(root, factory) {
  ...
  const PLUS_PAYMENT_STEP_KEY = 'paypal-checkout-flow';
  ...
  const NORMAL_PREFIX_STEP_DEFINITIONS = [
    ...
    { id: 9, order: 90, key: 'paypal-checkout-flow', title: 'PayPal 支付后续', sourceId: 'paypal-flow', driverId: 'content/paypal-flow', command: 'paypal-checkout-flow' },
  ...
  const PLUS_PAYPAL_PREFIX_STEP_DEFINITIONS = [
    ...
    { id: 8, order: 80, key: 'paypal-checkout-flow', title: 'PayPal 支付后续', sourceId: 'paypal-flow', driverId: 'content/paypal-flow', command: 'paypal-checkout-flow' },
  ...
  const PLUS_PAYPAL_HOSTED_CHECKOUT_PREFIX_STEP_DEFINITIONS = [
    ...
    { id: 5, order: 50, key: 'fill-profile', title: '填写姓名和生日', sourceId: 'openai-auth', driverId: 'content/signup-page', command: 'fill-profile' },
    { id: 6, order: 60, key: 'plus-checkout-create', title: '创建 Plus Checkout', sourceId: 'plus-checkout', driverId: 'content/plus-checkout', command: 'plus-checkout-create' },
    { id: 7, order: 70, key: 'paypal-checkout-flow', title: 'PayPal 支付后续', sourceId: 'paypal-flow', driverId: 'content/paypal-flow', command: 'paypal-checkout-flow' },
  ];
  ...
  const PLUS_PAYPAL_HOSTED_CHECKOUT_STEP_DEFINITIONS = createHostedCheckoutSteps(PLUS_PAYPAL_HOSTED_CHECKOUT_PREFIX_STEP_DEFINITIONS, 8, 80, SIGNUP_METHOD_EMAIL);
  ...
  const PLUS_PAYPAL_HOSTED_CHECKOUT_PHONE_STEP_DEFINITIONS = createHostedCheckoutSteps(PLUS_PAYPAL_HOSTED_CHECKOUT_PREFIX_STEP_DEFINITIONS, 8, 80, SIGNUP_METHOD_PHONE);
  const PLUS_PAYPAL_HOSTED_CHECKOUT_PHONE_BOUND_EMAIL_RELOGIN_STEP_DEFINITIONS = createHostedCheckoutSteps(PLUS_PAYPAL_HOSTED_CHECKOUT_PREFIX_STEP_DEFINITIONS, 8, 80, SIGNUP_METHOD_PHONE, { phoneSignupReloginAfterBindEmailEnabled: true });
